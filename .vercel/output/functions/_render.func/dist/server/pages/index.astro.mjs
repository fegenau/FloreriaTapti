/* empty css                                   */
import { e as createComponent, f as createAstro, m as maybeRenderHead, h as addAttribute, r as renderTemplate, l as renderComponent } from '../chunks/astro/server_CZQ_ue84.mjs';
import 'piccolore';
...
const $$Index = createComponent(($$result, $$props, $$slots) => {
  const mainServices = [
    ...
    //   title: "Suscripciones",
    //   description:
    //     "Recibe flores frescas semanalmente. Perfecto para oficinas y hogares",
    //   image:
    //     "https://images.unsplash.com/photo-1465146344425-f00d5f5c8f07?w=400&h=500&fit=crop&crop=center",
    //   url: "/membresias",
    // },
  ];
...
Conocer Membresías
<svg class="ml-3 w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"> <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 8l4 4m0 0l-4 4m4-4H3"></path> </svg> </a> ` })} </div> </div> </div>  ` })} <!-- Navegación flotante -->`;
