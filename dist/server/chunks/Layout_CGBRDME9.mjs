import { e as createComponent, f as createAstro, m as maybeRenderHead, h as addAttribute, r as renderTemplate, l as renderComponent, k as renderScript, n as renderSlot, o as renderHead } from './astro/server_JR3jxAAG.mjs';
import 'piccolore';
import 'clsx';
/* empty css                           */
...
const $$EntranceAnimation = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate(_a$1 || (_a$1 = __template$1(["", `<div id="entrance-animation" class="fixed inset-0 z-50 flex items-center justify-center bg-slate-950 cursor-pointer perspective-container" style="background-image: url('/loading-bg3.png'); background-size: cover; background-position: center;" data-astro-cid-5szvec7l> `, " ", ' </div> <script>\n  if (sessionStorage.getItem("tapti_intro_shown")) {\n    const el = document.getElementById("entrance-animation");\n    if (el) el.style.display = "none";\n  }\n<\/script> ', " "])), maybeRenderHead(), renderComponent($$result, "DoorsContainer", $$DoorsContainer, { "data-astro-cid-5szvec7l": true }), renderComponent($$result, "EntranceLogo", $$EntranceLogo, { "data-astro-cid-5szvec7l": true }), renderScript($$result, "D:/Trabajos/FloreriaTapti/src/components/EntranceAnimation.astro?astro&type=script&index=0&lang.ts"));
...
const $$ClientRouter = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<meta name="astro-view-transitions-enabled" content="true"><meta name="astro-view-transitions-fallback"${addAttribute(fallback, "content")}>${renderScript($$result, "D:/Trabajos/FloreriaTapti/node_modules/astro/components/ClientRouter.astro?astro&type=script&index=0&lang.ts")}`;
}, "D:/Trabajos/FloreriaTapti/node_modules/astro/components/ClientRouter.astro", void 0);
...
const $$Layout = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate(_a || (_a = __template(['<html lang="es" class="h-full" data-astro-cid-dmqsi53g> <head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><title>', "</title>", "<script", "></script>", "</head> <body", " data-astro-cid-dmqsi53g> ", ' <div id="main-content"', " data-astro-cid-dmqsi53g> ", " ", " <main", " data-astro-cid-dmqsi53g> ", " </main> ", " </div>  </body> </html>"])), title, renderComponent($$result, "ViewTransitions", $$ClientRouter, { "data-astro-cid-dmqsi53g": true }), addAttribute(`https://maps.googleapis.com/maps/api/js?key=${"AIzaSyCBpc6b9TL8TAvlWCFtHD3el8rKGCWz7Rc"}&libraries=places`, "src"), renderHead(), addAttribute(`min-h-screen bg-white text-gray-900 ${showEntrance ? "overflow-hidden" : "overflow-visible"}`, "class"), showEntrance && renderTemplate`${renderComponent($$result, "EntranceAnimation", $$EntranceAnimation, { "data-astro-cid-dmqsi53g": true })}`, addAttribute(showEntrance ? "opacity-0 transition-opacity duration-1000" : "opacity-100", "class"), renderScript($$result, "D:/Trabajos/FloreriaTapti/src/components/Layout.astro?astro&type=script&index=0&lang.ts"), renderComponent($$result, "FloatingNav", $$FloatingNav, { "data-astro-cid-dmqsi53g": true }), addAttribute(hideHeader ? "min-h-screen" : "min-h-[70vh]", "class"), renderSlot($$result, $$slots["default"]), !hideFooter && renderTemplate`<footer class="border-t border-white/10" data-astro-cid-dmqsi53g> <div class="max-w-6xl mx-auto px-4 py-8 text-sm flex items-center justify-between" data-astro-cid-dmqsi53g> <p data-astro-cid-dmqsi53g>© ${(/* @__PURE__ */ new Date()).getFullYear()} Tapti Flores y Regalos</p> <a href="https://wa.me/56900000000" class="hover:text-tapti-gold" data-astro-cid-dmqsi53g>
WhatsApp
</a> </div> </footer>`);
