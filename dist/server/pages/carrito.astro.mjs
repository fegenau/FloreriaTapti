/* empty css                                   */
import { e as createComponent, f as createAstro, m as maybeRenderHead, k as renderScript, h as addAttribute, r as renderTemplate, l as renderComponent } from '../chunks/astro/server_JR3jxAAG.mjs';
import 'piccolore';
...
Datos de Despacho
</h3> <div class="col-span-1 md:col-span-2 space-y-4"> <input type="text" name="name" placeholder="Nombre completo" required class="w-full bg-white/5 border border-white/20 rounded-lg px-4 py-2 text-white focus:border-honey-bronze-400 outline-none"> <input type="text" name="rut" placeholder="RUT (12.345.678-9)" required class="w-full bg-white/5 border border-white/20 rounded-lg px-4 py-2 text-white focus:border-honey-bronze-400 outline-none"> <input type="email" name="email" placeholder="Email" required class="w-full bg-white/5 border border-white/20 rounded-lg px-4 py-2 text-white focus:border-honey-bronze-400 outline-none"> <input type="tel" name="phone" placeholder="Teléfono (+569...)" required class="w-full bg-white/5 border border-white/20 rounded-lg px-4 py-2 text-white focus:border-honey-bronze-400 outline-none"> <input type="text" name="commune" placeholder="Comuna" required class="w-full bg-white/5 border border-white/20 rounded-lg px-4 py-2 text-white focus:border-honey-bronze-400 outline-none"> <input type="text" name="address" placeholder="Dirección calle/número" required class="w-full bg-white/5 border border-white/20 rounded-lg px-4 py-2 text-white focus:border-honey-bronze-400 outline-none"> <div class="col-span-1 md:col-span-2 flex justify-end gap-4 mt-4"> <button type="button" id="btn-cancel" class="px-6 py-3 border border-red-500/50 text-red-300 rounded-lg hover:bg-red-500/10 transition-colors">
Cancelar Compra
