...
import { c as createExports, s as serverEntrypointModule } from './chunks/_@astrojs-ssr-adapter_ClL9Ni0P.mjs';
import { manifest } from './manifest_CCFHABrQ.mjs';
...
const _page5 = () => import('./pages/api/validate-address.astro.mjs');
const _page6 = () => import('./pages/carrito.astro.mjs');
const _page7 = () => import('./pages/catalogo.astro.mjs');
const _page8 = () => import('./pages/confirmacion.astro.mjs');
const _page9 = () => import('./pages/contacto.astro.mjs');
const _page10 = () => import('./pages/membresias.astro.mjs');
const _page11 = () => import('./pages/producto/_slug_.astro.mjs');
const _page12 = () => import('./pages/sobre.astro.mjs');
const _page13 = () => import('./pages/webpay/return.astro.mjs');
...
const pageMap = new Map([
    ...
    ["src/pages/api/validate-address.ts", _page5],
    ["src/pages/carrito.astro", _page6],
    ["src/pages/catalogo.astro", _page7],
    ["src/pages/confirmacion.astro", _page8],
    ["src/pages/contacto.astro", _page9],
    ["src/pages/membresias.astro", _page10],
    ["src/pages/producto/[slug].astro", _page11],
    ["src/pages/sobre.astro", _page12],
    ["src/pages/webpay/return.astro", _page13],
